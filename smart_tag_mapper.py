...
from .memory.tag_tools import tinydb_find_similar_tags, _generate_embedding, _cosine_similarity
...
if __name__ == "__main__":
    # Add the src path for testing
    import sys
    sys.path.append('src')
    test_smart_tag_mapping()